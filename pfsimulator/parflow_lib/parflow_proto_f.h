...
#define CALL_CLM_LSM(pressure_data, saturation_data, evap_trans_data, mask, porosity_data,                                                                                     \
                     ...
                     qflx_infl_data, swe_out_data, snd_out_data, snoalb_out_data, surfalb_out_data, snowage_out_data, ndvi_out_data, qflx_snomelt_out_data, t_grnd_data, t_soil_data, \
